  ...
  return (
    <>
      ...
      <div id="main" className={styles.main}>
        ...
        <h2>
          Adquira seu Flipper Zero diretamente no Brasil com o dev @Patrick.Alura!
        </h2>
        <p>
      ...
      <div id="about" className={styles.about}>
        <div className={styles.text_wrapper}>
          <h2>Sobre nós</h2>
          <p>
            Como Pentester, professor na Alura.Online e revendedor do Flipper Zero desde 2021, @Patrick.Alura conquistou diversos clientes em todo o Brasil importando o Golfinho mais amado por Hackers & Geeks, clientes nos quais você pode consultar na central/grupo de referências!
        ...
        >
          ...
          <SwiperSlide className={styles.slide}>
            <blockquote>
              <p>
                <span>&ldquo;</span>
                Agradecer a Anna pelo unleashed configurado, chegou em 8 dias. Obrigado pelo suporte.
              </p>
              <cite>
                <img
      ...
      <footer className={styles.footer}>
        ...
        <div>
          ...
          <a href="https://www.instagram.com/patrick.alura">
